            ...
            <div className="flex flex-wrap items-top mb-6">
              ...
              <div className="w-full lg:w-4/12 px-4">
                ...
                <ul className="list-unstyled">
                  <li>
                    <Link
                        href="https://en.wikipedia.org/wiki/Virtual_private_server#:~:text=A%20virtual%20private%20server%20(VPS,VDS)%20has%20a%20similar%20meaning."
                        className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                    >
                      What is VPS
                    </Link>
                  ...
                  <li>
                    <Link
                      className="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                      href="https://www.inmotionhosting.com/blog/what-is-reseller-hosting/#:~:text=Reseller%20hosting%20is%20a%20type,to%20make%20reseller%20hosting%20profitable."
                    >

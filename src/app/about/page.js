    ...
    return (
        <div className="about-container text-white min-h-screen p-6">
            ...
            <section className="about-content max-w-4xl mx-auto space-y-10 animate-fade-in">
                ...
                <div className="meet-the-team space-y-6">
                    ...
                    <div className="team-members grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                        {[
                            ...
                            <div key={index} className="team-member text-center p-6 bg-gray-100 rounded-lg shadow-md hover:bg-indigo-100 hover:scale-105 transform transition duration-300 ease-out cursor-pointer">
